         ...
         <div className="font-inter  space-y-12 animate-in slide-in-from-bottom-8 duration-1000 pb-20">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 border-b border-slate-200 pb-8">
               <Link to="/payments" className="flex items-center gap-3 text-slate-400 hover:text-slate-900 transition-all group">
                  ...
                  <span className="text-[10px] font-medium uppercase tracking-[0.25em]">Audit Treasury</span>
               </Link>
               <div className="text-center">
                  <h1 className="text-3xl font-manrope font-medium text-slate-900 tracking-tighter uppercase">Revenue </h1>
                  <p className="text-[10px] text-slate-400 font-medium uppercase tracking-[0.3em] mt-2 italic opacity-60">Al Bayan Financial Protocol v2.4</p>
               </div>
               <button
                  onClick={handleSubmit}
                  disabled={isLoading}
                  className={`px-10 py-5 bg-black text-white rounded-xl font-medium text-[10px] uppercase tracking-[0.3em] shadow-xl hover:bg-[var(--desert-gold)] hover:text-black transition-all flex items-center gap-3 ${isLoading ? 'opacity-50 cursor-not-allowed' : ''}`}
               >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
               ...
               <div className="lg:col-span-4 space-y-10">
                  ...
                  <div className="bg-gradient-to-br from-[var(--sidebar-bg)] via-[var(--primary)] to-[var(--sidebar-bg)] rounded-xl p-10 text-white shadow-2xl relative overflow-hidden group">
                     ...
                     <p className="text-[10px] font-medium text-white/30 uppercase tracking-[0.3em] mb-12 relative z-10">Real-time Balance</p>
                        ...
                        return (
                           <div className="space-y-10 relative z-10">
                              <div className="flex items-center justify-between">
                                 ...
                                 <span className="text-2xl font-manrope font-medium tracking-tight text-white">${outstanding.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                              </div>
                              <div className="flex items-center justify-between">
                                 <span className="text-xs font-medium text-white/40 uppercase tracking-widest">Inflow Total</span>
                                 <span className="text-2xl font-manrope font-medium text-[var(--sacred-emerald)] tracking-tight">${inflowTotal.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                              </div>
                              ...
                              <div className="flex items-center gap-4">
                                 ...
                                 <div>
                                    <p className="text-[10px] font-medium uppercase tracking-[0.2em] text-white/30 mb-1">For Account</p>
                                    <p className="text-xs font-medium text-white tracking-tight uppercase">{customerDisplay}</p>
                                 </div>
                              </div>
                           </div>
                        );
                  ...
                  <div className="bg-white rounded-xl p-10 border border-slate-200 shadow-sm relative overflow-hidden group">
                     <h3 className="text-[10px] font-medium text-slate-400 uppercase tracking-[0.3em] mb-10 flex items-center gap-3">
                     ...
                     <div className="space-y-8">
                        {paymentHistory.map((item, idx) => (
                           <div key={idx} className="flex justify-between items-start border-l-2 border-slate-100 pl-6 group/item hover:border-black transition-all">
                              <div>
                                 <p className="text-xs font-medium text-slate-900 leading-none">${item.amount.toLocaleString()}</p>
                              ...
                              <div className="flex items-center gap-2">
                                 ...
                                 <span className="text-[8px] font-medium text-slate-300 uppercase tracking-tighter">{item.method}</span>
                              </div>
                           </div>
                        ))}
                     </div>
                     <button className="w-full mt-10 py-4 bg-slate-50 border border-slate-100 rounded-xl text-[9px] font-medium text-slate-400 uppercase tracking-[0.3em] hover:bg-black hover:text-white transition-all shadow-sm">
               ...
               <div className="lg:col-span-8 space-y-10">
                  ...
                  <div className="bg-white rounded-xl p-12 shadow-sm border border-slate-200 group relative overflow-hidden">
                     ...
                     <h3 className="text-[10px] font-medium text-slate-400 uppercase tracking-[0.4em] mb-12 flex items-center gap-3 relative z-10">
                        <Landmark size={18} strokeWidth={3} className="text-[var(--desert-gold)]" /> Allocation Details
                     </h3>

                     <div className="grid grid-cols-1 md:grid-cols-2 gap-16 relative z-10">
                        <div className="group">
                           <label className="text-[10px] font-medium text-slate-400 uppercase tracking-widest mb-4 block ml-1">Registry Selection (Booking)</label>
                           <div className="relative border-b-2 border-slate-100 group-focus-within:border-black transition-all pb-4">
                              <select
                                 className="w-full bg-transparent text-lg font-manrope font-medium text-slate-900 outline-none appearance-none cursor-pointer"
                        ...
                        <div className="group">
                           <label className="text-[10px] font-medium text-slate-400 uppercase tracking-widest mb-4 block ml-1">Liquidity Conduit</label>
                           <div className="relative border-b-2 border-slate-100 group-focus-within:border-black transition-all pb-4">
                              <select
                                 className="w-full bg-transparent text-lg font-manrope font-medium text-slate-900 outline-none appearance-none cursor-pointer"
                  ...
                  <div className="bg-white rounded-xl p-12 shadow-sm border border-slate-200 group relative overflow-hidden">
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mb-16 relative z-10">
                        <div className="group">
                           <label className="text-[10px] font-medium text-slate-400 uppercase tracking-widest mb-4 block ml-1">Receipt Valuation</label>
                           <div className="relative border-b-2 border-slate-100 group-focus-within:border-[var(--sacred-emerald)] transition-all pb-4 flex items-center justify-between">
                              <input
                                 ...
                                 className="w-full bg-transparent text-3xl font-manrope font-medium text-[var(--sacred-emerald)] outline-none tracking-tighter"
                        ...
                        <div className="group">
                           <label className="text-[10px] font-medium text-slate-400 uppercase tracking-widest mb-4 block ml-1">Execution Date</label>
                           <div className="relative border-b-2 border-slate-100 group-focus-within:border-black transition-all pb-4 flex items-center justify-between">
                              <input
                                 type="date"
                                 className="w-full bg-transparent text-lg font-manrope font-medium text-slate-900 outline-none"
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-16 relative z-10">
                        <div className="group">
                           <label className="text-[10px] font-medium text-slate-400 uppercase tracking-widest mb-4 block ml-1">Reference Index (Check/TX ID)</label>
                           <div className="relative border-b-2 border-slate-100 group-focus-within:border-black transition-all pb-4">
                              <input
                                 type="text"
                                 placeholder="TX-00912883..."
                                 className="w-full bg-transparent text-sm font-manrope font-medium text-slate-900 outline-none placeholder-slate-200 uppercase tracking-widest"
                        ...
                        <div className="group">
                           <label className="text-[10px] font-medium text-slate-400 uppercase tracking-widest mb-4 block ml-1">Ledger Annotations (Notes)</label>
                           <div className="relative border-b-2 border-slate-100 group-focus-within:border-black transition-all pb-4">
                              <input
                                 type="text"
                                 placeholder="Deposit for Ramadan segment..."
                                 className="w-full bg-transparent text-sm font-manrope font-medium text-slate-900 outline-none placeholder-slate-200"
