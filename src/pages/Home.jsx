...
const Home = () => {
    ...
    return (
        ...
        >
            ...
            >
                <div>
                    <p className="text-[10px] font-medium text-[var(--secondary)] uppercase tracking-[0.3em] mb-1">
                        Al-Amin Travel Group
                    </p>
                    <h1 className="text-3xl sm:text-4xl lg:text-5xl font-medium text-[var(--on-surface)] tracking-tight leading-none">
                        Executive Dashboard
                    </h1>
                ...
                <div className="flex items-center gap-3 self-start sm:self-auto">
                    <div className="flex items-center gap-2 bg-white px-4 py-2.5 rounded-xl border border-gray-100 shadow-sm">
                        ...
                        <span className="text-[10px] font-medium text-gray-700 uppercase tracking-widest whitespace-nowrap">
                            Global Ops Online
                        </span>
                    </div>
                </div>
            ...
            <div className="grid gap-4 sm:gap-6 grid-cols-1 sm:grid-cols-3">
                ...
                >
                    ...
                    <div className="absolute -top-10 -right-10 w-40 h-40 bg-[var(--primary)]/5 rounded-full blur-3xl group-hover:scale-125 transition-transform duration-500 pointer-events-none" />
                    ...
                    <div className="relative z-10 flex justify-between items-start mb-8">
                        ...
                        <span className="px-3 py-1 bg-[var(--primary)]/10 text-[var(--primary)] text-[10px] font-medium uppercase tracking-widest rounded-full border border-[var(--primary)]/10">
                            {metrics?.active_inquiries?.growth || '0%'} Growth
                        </span>
                    </div>

                    <div className="relative z-10">
                        <p className="text-[10px] font-medium text-gray-400 uppercase tracking-[0.25em] mb-2">
                            Active Inquiries
                        </p>
                        {/* Main Value - Dark Black Text */}
                        <h2 className=" text-3xl   sm:text-4xl md:text-5xl font-medium tracking-tighter text-gray-900 leading-none">
                ...
                >
                    ...
                    <div className="relative z-10 flex justify-between items-start mb-8">
                        ...
                        <span className="px-3 py-1 bg-[#10B981]/10 text-[#10B981] text-[10px] font-medium uppercase tracking-widest rounded-full border border-[#10B981]/10">
                ...
                >
                    ...
                    <div className="relative z-10 flex justify-between items-start mb-8">
                        ...
                        <span className="px-3 py-1 bg-[#3B82F6]/10 text-[#3B82F6] text-[10px] font-medium uppercase tracking-widest rounded-full border border-[#3B82F6]/10">
            ...
            <div className="grid gap-4 sm:gap-6 grid-cols-1 xl:grid-cols-3">
                ...
                >
                    <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 mb-6">
                        <div>
                            <h3 className="text-xl sm:text-2xl font-medium text-[#111827] tracking-tighter leading-none mb-1.5">
                                Performance Matrix
                            </h3>
                        ...
                        <div className="flex p-1 bg-gray-50 rounded-xl border border-gray-200 self-start shrink-0">
                            {['Weekly', 'Monthly', 'Yearly'].map(filter => (
                                <button
                                    ...
                                    className={`px-3 sm:px-5 py-2 rounded-xl text-[10px] font-medium uppercase tracking-wider transition-all ${timeFilter === filter
                ...
                >
                    <div className="mb-6">
                        <div className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-[var(--primary)]/8 border border-[var(--primary)]/20 rounded-full text-[9px] font-medium text-[var(--primary)] uppercase tracking-widest mb-4">
                            <ShieldCheck size={11} /> Global Entry Matrix
                        </div>
                        <h3 className="text-xl sm:text-2xl font-medium tracking-tighter leading-none mb-1.5 text-[var(--on-surface)]">
                            Acquisition
                        </h3>
                        <p className="text-[10px] font-medium text-gray-400 uppercase tracking-widest">
                            ...
                            {pieData.map((item) => (
                                <div key={item.label} className="flex flex-col gap-1 group cursor-default">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <span className="text-[11px] font-medium text-[var(--primary)] ml-1">{item.value}%</span>
                                    </div>
            ...
            <div className="grid gap-4 sm:gap-6 grid-cols-1 lg:grid-cols-5">
                ...
                >
                    <div className="flex items-start justify-between mb-8">
                        <div>
                            <h3 className="text-xl sm:text-2xl font-medium text-[var(--on-surface)] tracking-tighter leading-none mb-1.5">
                                Regional Dominance
                            </h3>
                            <p className="text-[10px] font-medium text-gray-400 uppercase tracking-widest">
                        ...
                        <div className="w-10 h-10 bg-[var(--primary)]/8 rounded-xl flex items-center justify-center shrink-0">
                            ...
                            <div key={idx} className="space-y-2">
                                <div className="flex justify-between items-center">
                                    ...
                                    <div className="flex items-baseline gap-1.5">
                                        <span className="text-base font-medium text-[var(--on-surface)]">{region.leads}</span>
                                        <span className="text-[10px] font-medium text-gray-400 uppercase">Leads</span>
                                    </div>
                                </div>
                    ...
                    <div className="flex-1 space-y-2 max-h-[380px] overflow-y-auto pr-1 -mr-1"
                        ...
                        {isLoading ? (
                            <div className="flex flex-col items-center justify-center py-16 text-gray-300">
                                <Activity className="animate-spin text-[var(--primary)] mb-4" size={36} />
                            ...
                            activities.map((act) => (
                                ...
                                >
                                    <div className={`w-10 h-10 sm:w-12 sm:h-12 rounded-xl flex items-center justify-center shrink-0 transition-transform group-hover:scale-105 ${act.status === 'success'
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <h4 className="text-sm font-medium text-[var(--on-surface)] tracking-tight mb-0.5 truncate">
                                            {act.title}
                                        </h4>
                                    ...
                                    <div className="text-right shrink-0 ml-2">
                                        <p className="text-[10px] font-medium text-[var(--primary)] uppercase tracking-wider mb-1">
                                            {act.time}
                                        </p>
