               ...
               <table className="w-full text-left border-collapse">
                  <thead>
                     <tr className="bg-slate-50 border-b border-slate-100">
                        ...
                        <th className="px-10 py-8 text-[10px] font-medium text-slate-400 uppercase tracking-[0.4em]">Service Level</th>
                        <th className="px-10 py-8 text-[10px] font-medium text-slate-400 uppercase tracking-[0.4em]">Liquidity Status</th>
                        <th className="px-10 py-8 text-[10px] font-medium text-slate-400 uppercase tracking-[0.4em]">Aggregate Value</th>
                        <th className="px-10 py-8 text-[10px] font-medium text-slate-400 uppercase tracking-[0.4em] text-right">Registry Date</th>
                     </tr>
                  </thead>
                  <tbody className="divide-y divide-slate-100">
                     {isLoading ? (
                        <tr><td colSpan="5" className="px-10 py-10 text-center text-xs font-medium uppercase tracking-widest text-slate-400">Synchronizing Ledger...</td></tr>
                     ) : paginatedData.length === 0 ? (
                        <tr><td colSpan="5" className="px-10 py-10 text-center text-xs font-medium uppercase tracking-widest text-slate-400">No active protocols found.</td></tr>
                        ...
                        <tr key={booking.id} className="group hover:bg-slate-50 transition-all cursor-pointer">
                           ...
                           <td className="py-10">
                              <span className="  font-medium text-slate-900 bg-white    uppercase tracking-widest transition-all">
                                 {getPackageName(booking.package)}
                              </span>
                           </td>
                           <td className="px-10 py-10">
                              <div className="flex items-center gap-4">
                                 <div className={`w-3 h-3 rounded-full ${booking.status === 'Confirmed' ? 'bg-[var(--sacred-emerald)] shadow-[0_0_10px_var(--sacred-emerald)]' :
                           ...
                           <td className="px-10 py-10">
                              <div className="space-y-3">
                                 <p className="text-2xl font-manrope font-medium text-slate-900 tracking-tighter leading-none">
                           ...
                           <td className="px-10 py-10 text-right">
                              <p className="text-[10px] font-medium text-slate-400 uppercase tracking-[0.4em] mb-3">{booking.created_at ? new Date(booking.created_at).toLocaleDateString() : 'N/A'}</p>
