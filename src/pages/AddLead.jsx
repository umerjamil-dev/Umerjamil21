      ...
      <>
         <div className="font-inter space-y-8 animate-in fade-in duration-500 max-w-[1400px] mx-auto">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
               <div>
                  <h1 className="text-2xl font-manrope font-medium text-[var(--on-surface)] tracking-tight leading-tight">
                     Capture New Inquiry
                  </h1>
               ...
               <div className="flex items-center gap-3 shrink-0">
                  <Link
                     to="/leads"
                     className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl border border-[var(--outline-variant)] text-[11px] font-medium uppercase tracking-widest text-[var(--on-surface-variant)] bg-[var(--surface-container-lowest)] hover:bg-[var(--surface-container-high)] transition-colors"
                  >
                  ...
                  <button
                     ...
                     disabled={isLoading}
                     className={`inline-flex items-center gap-2 px-6 py-2.5 rounded-xl text-[11px] font-medium uppercase tracking-widest text-white transition-all
                     ${isLoading
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
               ...
               <div className="flex flex-col gap-6">
                        ...
                        {masterData.lead.map((s) => {
                           ...
                           return (
                              <button
                                 ...
                                 className={`py-2.5 rounded-xl text-[10px] font-medium uppercase tracking-widest transition-all duration-150 border
                                 ${isSelected
                  ...
                  <div className="rounded-2xl p-6 bg-[var(--on-surface)] text-[var(--surface)] relative overflow-hidden">
                     ...
                     <h4 className="text-[11px] font-medium uppercase tracking-widest mb-1.5 text-white/90">Protocol Note</h4>
