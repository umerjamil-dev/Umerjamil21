                        ...
                        {allTypes.map((m, i) => (
                           ...
                           >
                              <div className="flex flex-col gap-2">
                                 <span
                                    className="text-[8px] font-medium uppercase tracking-[0.15em] px-2 py-1 rounded w-fit"
                                    style={{ background: '#e2e0d8', color: '#78776f' }}
                                 >
                                    {m.type}
                                 </span>
                                 <h4
                                    className="text-[13px] font-medium text-[#1a1916] line-clamp-2 leading-snug mt-1"
                                    style={{ fontFamily: "'Sora', sans-serif" }}
                                 >
                                    {m.name}
                                 </h4>
                              </div>
                              <p className="text-[9px] font-medium text-[#b0aea5] uppercase tracking-[0.12em] mt-4">
                                 ID — {m.id || i + 1}
                              </p>
                           </div>
                        ))}
