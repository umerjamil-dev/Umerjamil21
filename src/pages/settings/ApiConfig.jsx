                        ...
                        >
                           ...
                           <div className="flex flex-col gap-3">
                              <div className="flex items-center gap-2.5">
                                 ...
                                 <h4
                                    className="text-[13px] font-medium text-[#1a1916] uppercase tracking-[0.08em]"
                           ...
                           <div className="flex items-center gap-5 shrink-0">
                              <div
                                 className="flex items-center gap-2 px-3.5 py-1.5 rounded-lg text-[9px] font-medium uppercase tracking-[0.15em]"
                                 style={
                                    isConnected
                              ...
                              <button
                                 className="text-[9px] font-medium uppercase tracking-[0.15em] transition-colors cursor-pointer"
                                 style={{ color: '#c5c2b8' }}
