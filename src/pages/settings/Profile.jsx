      ...
      <div className="min-h-screen bg-gray-100 px-8 py-14 lg:px-20" style={{ fontFamily: "'DM Mono', monospace" }}>
        ...
        >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.97 }}
            disabled={isLoading}
            className="h-12 px-8 rounded-lg text-[10px] font-medium uppercase tracking-[0.15em] flex items-center gap-2.5 transition-all cursor-pointer shrink-0 disabled:opacity-50"
          ...
          >
            ...
            >
              <div className="relative">
                <div
                  className="w-24 h-24 rounded-2xl flex items-center justify-center text-white text-4xl font-medium select-none"
              ...
              <div className="text-center lg:text-left">
                <h3
                  className="text-[16px] font-medium text-[#1a1916] leading-tight"
                  style={{ fontFamily: "'Sora', sans-serif" }}
                >
                  {formData.name || 'Admin'}
                </h3>
                <p className="text-[9px] font-medium uppercase tracking-[0.2em] text-[#78776f] mt-1">
                  Prime Controller
                </p>
              </div>
            </div>
            ...
            >
              {[
                ...
                >
                  ...
                  <div>
                    <p className="text-[9px] font-medium uppercase tracking-[0.15em] text-[#b0aea5]">{label}</p>
                    <p className="text-[11px] font-medium mt-0.5" style={{ color: valueColor }}>{value}</p>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="flex flex-col gap-2">
              {[
                ...
                >
                  ...
                  <span className="text-[9px] font-medium uppercase tracking-[0.15em] text-[#b0aea5]">{text}</span>
                </div>
              ))}
              <div
                ...
                style={{ background: '#ffffff', border: '1.5px solid #e2e0d8' }}
              >
                <span className="text-[9px] font-medium uppercase tracking-[0.12em] text-[#b0aea5]">Identity Index</span>
                <span className="text-[9px] font-medium text-[#1a1916]">#PX-91283746</span>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            >
              ...
              <div className="px-8 py-6" style={{ borderBottom: '1.5px solid #e2e0d8' }}>
                <p className="text-[9px] font-medium uppercase tracking-[0.18em] text-[#78776f] mb-1">Credentials</p>
                <h2
                  className="text-[18px] font-medium text-[#1a1916]"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 px-8 py-8">
                ...
                {/* Password field */}
                <div className="flex flex-col gap-2">
                  <label className="text-[9px] font-medium uppercase tracking-[0.15em] text-[#78776f]">Access Protocol</label>
                  <div
                    className="flex items-center gap-3 rounded-lg px-4 py-3 transition-all"
                    style={{ background: '#f5f4f0', border: '1.5px solid #e2e0d8' }}
                    onFocusCapture={e => { e.currentTarget.style.borderColor = '#1a1916'; e.currentTarget.style.background = '#ffffff'; }}
