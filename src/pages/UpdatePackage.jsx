                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 pb-4">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <button
                            ...
                            disabled={isLoading}
                            className="btn-primary px-10 py-4 rounded-xl text-white text-[10px] font-medium uppercase tracking-[0.3em] shadow-2xl flex items-center gap-3 active:scale-95 transition-all disabled:opacity-50"
                        >
                                    ...
                                    <div className="p-10 bg-[var(--surface)] rounded-2xl border border-[var(--outline-variant)] group/slider hover:bg-white transition-all shadow-sm">
                                        ...
                                        <div className="flex items-center gap-8">
                                            ...
                                            <div className="text-right shrink-0">
                                                <span className="text-4xl font-manrope font-medium text-[var(--on-surface)]">{formData.nights_makkah}</span>
                    ...
                    <div className="lg:col-span-4 space-y-10">
                        <div className="bg-[#0f172a] rounded-3xl p-12 text-white shadow-2xl overflow-hidden group min-h-[440px] flex flex-col justify-between">
                            <div className="relative z-10">
                                ...
                                <h4 className="text-3xl font-manrope font-medium tracking-tighter mb-6 leading-tight">Configuration </h4>
