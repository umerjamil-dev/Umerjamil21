    ...
    <div className="space-y-8 animate-in fade-in duration-700 pb-20 font-inter">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          ...
          <h1 className="text-4xl font-manrope font-black text-slate-900 tracking-tight">Service Status Report</h1>
        ...
        <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
          ...
          <div className="space-y-3">
            ...
            <select
              ...
              className="w-full bg-slate-50 border border-slate-100 rounded-xl px-4 py-3 text-sm font-bold outline-none focus:border-black transition-all appearance-none cursor-pointer"
            >
        ...
        {isLoading && (
          <div className="absolute inset-0 z-50 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center">
            <div className="flex flex-col items-center gap-4">
              ...
              <span className="text-[10px] font-black text-white uppercase tracking-widest">Aggregating Report Data...</span>
            </div>
          </div>
        )}
        ...
        <div className="h-full w-full flex flex-col">
          <div className="p-4 bg-slate-800 border-b border-slate-700 flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Service Status PDF Viewer</span>
            </div>
            <a 
              href={pdfUrl} 
