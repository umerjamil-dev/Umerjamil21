  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-700 pb-20 font-inter">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          <div className="flex items-center gap-2 text-[var(--desert-gold)] uppercase tracking-[0.3em] text-[10px] font-medium mb-2">
            <BarChart3 size={14} /> Analytics Hub
          </div>
          <h1 className="text-4xl font-manrope font-medium text-slate-900 tracking-tight">Booking Analytics</h1>
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            disabled={isLoading}
            className="px-8 py-4 bg-black text-white rounded-xl text-[10px] font-medium uppercase tracking-widest hover:bg-[var(--desert-gold)] hover:text-black transition-all shadow-xl disabled:opacity-50"
          >
        ...
        {isLoading && (
          <div className="absolute inset-0 z-50 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center">
            <div className="flex flex-col items-center gap-4">
              ...
              <span className="text-[10px] font-medium text-white uppercase tracking-widest">Generating Base64 Ledger...</span>
            </div>
          </div>
        )}
        ...
        <div className="h-full w-full flex flex-col">
          <div className="p-4 bg-slate-800 border-b border-slate-700 flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <span className="text-[10px] font-medium text-slate-400 uppercase tracking-widest">Protocol PDF Generator v1.0</span>
            </div>
            <a
              href={pdfUrl}
